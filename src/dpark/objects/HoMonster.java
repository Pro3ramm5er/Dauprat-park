 ...
 */
public class HoMonster extends GameObject {
    ...
    public HoMonster(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("HoMonster_left.png"));
        sprite.addStep(Game.instance.getSprite("HoMonster_up.png"));
        sprite.addStep(Game.instance.getSprite("HoMonster_right.png"));
        sprite.addStep(Game.instance.getSprite("HoMonster_down.png"));
