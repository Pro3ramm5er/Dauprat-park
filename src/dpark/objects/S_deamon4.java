 ...
 * @author Nickita
 */
public class S_deamon4 extends GameObject {
    ...
    public S_deamon4(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("S_d3_1.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_1.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_2.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_2.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_3.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_3.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_4.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_4.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_5.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_5.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_6.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_6.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_7.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_7.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_8.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_8.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_9.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_9.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_10.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_10.png"));

        sprite.addStep(Game.instance.getSprite("S_d3_11.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_11.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_10.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_10.png"));
        sprite.addStep(Game.instance.getSprite("S_d3_9.png"));
