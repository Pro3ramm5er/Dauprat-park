 ...
 * @author Nickita
 */
public class Radiation_zombie extends GameObject {
    ...
    public int Minus = 0;
    public Radiation_zombie(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Rad_zombie_left.png"));
        sprite.addStep(Game.instance.getSprite("Rad_zombie_up.png"));
        sprite.addStep(Game.instance.getSprite("Rad_zombie_rigth.png"));
        sprite.addStep(Game.instance.getSprite("Rad_zombie_down.png"));
