 ...
 */
public class Pesokman extends GameObject {
    ...
    public int Minus = 0;
    public Pesokman(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Pesokman_left.png"));
        sprite.addStep(Game.instance.getSprite("Pesokman_up.png"));
        sprite.addStep(Game.instance.getSprite("Pesokman_right.png"));
        sprite.addStep(Game.instance.getSprite("Pesokman_down.png"));
