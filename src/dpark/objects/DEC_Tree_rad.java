 ...
 * @author Nickita
 */
public class DEC_Tree_rad extends GameObject {
    public int xt;
    public int yt;
    ...
    public DEC_Tree_rad(String name)
    {
        super(name);
        sprite.addStep(Game.instance.getSprite("DEC_rad_tree.png"));
        sprite.addStep(Game.instance.getSprite("DEC_rad_tree_2.png"));
        sprite.addStep(Game.instance.getSprite("DEC_rad_tree_3.png"));


        sprite.currentStep = Game.instance.GetRandom(0, 2);
