 ...
 * @author Nickita
 */
public class Sphuyna extends  GameObject {
    public int xt;
    public int yt;
    ...
    public Sphuyna(String name)
    {
        super(name);
        sprite.addStep(Game.instance.getSprite("Spacehuyna.png"));
        sprite.addStep(Game.instance.getSprite("Spacehuyna_2.png"));
