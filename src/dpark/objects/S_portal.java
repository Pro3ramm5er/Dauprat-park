 ...
 * @author Nickita
 */
public class S_portal extends GameObject {
    ...
    public int ChangeXYTimer = 145;
    public S_portal(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Portal_1.png"));
        sprite.addStep(Game.instance.getSprite("Portal_1.png"));
        sprite.addStep(Game.instance.getSprite("Portal_2.png"));
        sprite.addStep(Game.instance.getSprite("Portal_2.png"));
        sprite.addStep(Game.instance.getSprite("Portal_3.png"));
        sprite.addStep(Game.instance.getSprite("Portal_3.png"));
        sprite.addStep(Game.instance.getSprite("Portal_4.png"));
        sprite.addStep(Game.instance.getSprite("Portal_4.png"));
    ...
    public void update() {
        ...
        if (ChangeXYTimer <= 0)
        {
            x = Game.instance.GetRandom(45, 500);
            y = Game.instance.GetRandom(45, 500);
            ChangeXYTimer = 150;
        } else {
            ChangeXYTimer--;
        }
