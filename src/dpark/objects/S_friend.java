 ...
 * @author Nickita
 */
public class S_friend extends GameObject {
    ...
    public int xt;
    public int yt;
    public int MST = 0; // 1 - up, 2 - right, 3 - down, 4 - left
    public int Timer = 50;
    public int Timer_2;
    ...
    public int Minus = 0;
    public int Screamtimer = 25;
    public int Screamnow = 0;
    public int i = 0;
    public int i2 = 0;

    public S_friend(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Atr_down.png"));
    ...
    public void update() {
        ...
        if (GameStoryVars.S_funnymeet == 1)
        {
            if (Screamtimer <= 0 && Screamnow == 0) {
                Screamtimer = 45;
                Screamnow = 1;
                ...
                MST = 3;
                Screamtimer--;
              //GameStoryVars.S_funnymeet = 0;
            }
            if (Screamtimer <= 0 && Screamnow == 1) {
                Screamtimer = 45;
                Screamnow = 2;
                sprite.currentStep = 0;
            } else {
