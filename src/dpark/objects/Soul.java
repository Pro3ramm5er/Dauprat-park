 ...
 * @author Nickita
 */
public class Soul extends GameObject {
    ...
    public Soul(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Soul_left.png"));
        sprite.addStep(Game.instance.getSprite("Soul_up.png"));
        sprite.addStep(Game.instance.getSprite("Soul_right.png"));
        sprite.addStep(Game.instance.getSprite("Soul_down.png"));
