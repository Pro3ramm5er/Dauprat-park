...
public class S_decwall2 extends GameObject {
    ...
    public S_decwall2(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Wall_dec2.png"));
