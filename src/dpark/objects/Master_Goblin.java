 ...
 */
public class Master_Goblin extends GameObject {
    ...
    public Master_Goblin(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("GoblinMaster_left.png"));
        sprite.addStep(Game.instance.getSprite("GoblinMaster_up.png"));
        sprite.addStep(Game.instance.getSprite("GoblinMaster_right.png"));
        sprite.addStep(Game.instance.getSprite("GoblinMaster_down.png"));
