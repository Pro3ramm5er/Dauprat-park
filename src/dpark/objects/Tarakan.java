 ...
 * @author Nickita
 */
public class Tarakan extends GameObject {
    ...
    public Tarakan(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Tarakan_left.png"));
        sprite.addStep(Game.instance.getSprite("Tarakan_down.png"));
        sprite.addStep(Game.instance.getSprite("Tarakan_right.png"));
        sprite.addStep(Game.instance.getSprite("Tarakan_down.png"));
