 ...
 * @author Nickita
 */
public class Snowbug extends GameObject {
    public int xt;
    public int yt;
    ...
    public Snowbug(String name)
    {
        super(name);
        sprite.addStep(Game.instance.getSprite("Snowbug.png"));
        sprite.addStep(Game.instance.getSprite("Snowbug_2.png"));
