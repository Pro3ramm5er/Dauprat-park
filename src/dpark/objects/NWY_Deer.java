 ...
 * @author Nickita
 */
public class NWY_Deer extends GameObject {
    ...
    public NWY_Deer(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Olen_left.png"));
        sprite.addStep(Game.instance.getSprite("Olen_1.png"));
        sprite.addStep(Game.instance.getSprite("Olen_right.png"));
        sprite.addStep(Game.instance.getSprite("Olen_down.png"));
        z = 5;
    }
