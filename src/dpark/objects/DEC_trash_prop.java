 ...
 * @author Nickita
 */
public class DEC_trash_prop extends GameObject {
    ...
    public DEC_trash_prop(String name) {
        super(name);
        z = yt-2;


        sprite.addStep(Game.instance.getSprite("DEC_trash.png"));
        sprite.addStep(Game.instance.getSprite("DEC_trash_2.png"));
