 ...
 * @author Nickita
 */
public class S_deamon extends GameObject {
    ...
    public S_deamon(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("S_deamon_l.png"));
        sprite.addStep(Game.instance.getSprite("S_deamon_uu.png"));
        sprite.addStep(Game.instance.getSprite("S_deamon_r.png"));
        sprite.addStep(Game.instance.getSprite("S_deamon_d.png"));
