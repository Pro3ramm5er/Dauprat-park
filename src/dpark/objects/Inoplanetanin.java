 ...
 */
public class Inoplanetanin extends GameObject {
    ...
    public int Minus = 0;
    public Inoplanetanin(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Innop_left.png"));
        sprite.addStep(Game.instance.getSprite("Innop_up.png"));
        sprite.addStep(Game.instance.getSprite("Innop_right.png"));
        sprite.addStep(Game.instance.getSprite("Innop_down.png"));
