...
public class Egg extends GameObject {
    ...
    {
        super(name);
        sprite.addStep(Game.instance.getSprite("Egg.png"));
        sprite.addStep(Game.instance.getSprite("Egg.png"));
        sprite.addStep(Game.instance.getSprite("Egg_1.png"));
        sprite.addStep(Game.instance.getSprite("Egg_1.png"));
        sprite.addStep(Game.instance.getSprite("Egg_2.png"));
        sprite.addStep(Game.instance.getSprite("Egg_2.png"));
        sprite.addStep(Game.instance.getSprite("Egg_3.png"));
        sprite.addStep(Game.instance.getSprite("Egg_3.png"));
        sprite.addStep(Game.instance.getSprite("Egg_4.png"));
        sprite.addStep(Game.instance.getSprite("Egg_4.png"));
        sprite.addStep(Game.instance.getSprite("Egg_4.png"));
        sprite.addStep(Game.instance.getSprite("Egg_4.png"));
