 ...
 * @author Nickita
 */
public class S_deamon2 extends GameObject {
    ...
    public S_deamon2(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("S_deamon2_d_1.png"));
        sprite.addStep(Game.instance.getSprite("S_deamon2_d_1.png"));
        sprite.addStep(Game.instance.getSprite("S_deamon2_d_2.png"));
        sprite.addStep(Game.instance.getSprite("S_deamon2_d_2.png"));
