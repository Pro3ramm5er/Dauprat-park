 ...
 */
public class MegaBear extends GameObject {
    ...
    public MegaBear(String name) {
        super(name);
        sprite.addStep(Game.instance.getSprite("Megabear_left.png"));
        sprite.addStep(Game.instance.getSprite("Megabear_up.png"));
        sprite.addStep(Game.instance.getSprite("Megabear_right.png"));
        sprite.addStep(Game.instance.getSprite("Megabear_down.png"));
